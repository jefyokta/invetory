<x-container class="flex flex-col justify-center items-center">
    <div class="mb-5">
        <x-page-title>Edit Barang</x-page-title>
    </div>
    <form class="w-10/12 mx-auto space-y-6" wire:submit="save">
        ...
        <div>
            <x-primary-button>Buat <span class="loading loading-spinner loading-xs" wire:loading></span>
            </x-primary-button>
        </div>
        <x-action-message on="updated">Berhasil update</x-action-message>
